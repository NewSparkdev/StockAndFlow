        ...
        private async Task SaveAsync()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    System.Diagnostics.Debug.WriteLine("Sale failed - insufficient inventory or item not found");
                    CloseRequested?.Invoke(this, false);
                }
            }
            catch (Exception ex)
            {
                System.Diagnostics.Debug.WriteLine($"Error recording sale: {ex.Message}");
                CloseRequested?.Invoke(this, false);
            }
        }
