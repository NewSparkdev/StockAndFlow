...
namespace StockAndFlow.ViewModels
{
    public class AddEditExpenseViewModel : ViewModelBase
    {
        ...
        public AddEditExpenseViewModel(ExpenseService expenseService, InventoryService inventoryService)
        {
            ...
            BrowseReceiptCommand = new RelayCommand(BrowseReceipt);
        ...
        private void BrowseReceipt()
        {
            ...
            {
                ReceiptImagePath = dialog.FileName;
            }
        }
